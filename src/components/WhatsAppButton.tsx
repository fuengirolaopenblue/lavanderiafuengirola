...
const WhatsAppButton = () => {
  return (
    <motion.a
      ...
      className="fixed bottom-6 right-6 z-50 flex items-center gap-2 bg-[#25D366] rounded-full pl-3 pr-5 py-2.5 shadow-[0_4px_12px_rgba(0,0,0,0.2)] hover:shadow-[0_6px_20px_rgba(0,0,0,0.3)] hover:scale-105 transition-all duration-300"
