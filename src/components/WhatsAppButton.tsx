  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex items-center gap-3">
      ...
      <motion.div
        ...
        className="hidden sm:block bg-card text-foreground text-xs font-semibold px-4 py-2 rounded-full shadow-elevated border border-border/50 whitespace-nowrap"
      >
        {t("whatsapp.tooltip")}
      </motion.div>
      ...
      {/* Button */}
      <motion.a
        href="https://wa.me/34641819577?text=Hola%2C%20me%20gustar%C3%ADa%20informaci%C3%B3n%20sobre%20el%20servicio%20para%20viviendas%20vacacionales%20en%20Fuengirola"
        target="_blank"
